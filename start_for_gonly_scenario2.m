function [N,Ng,Nb,Nc,buildings]=start_for_gonly_scenario2()
% Author: Ankur Pipri
...
%% In case the same building parameters are required as before please uncomment this line and comment the 
%  the section named 'Generation of augmented building parameters' below
load('b_data');
