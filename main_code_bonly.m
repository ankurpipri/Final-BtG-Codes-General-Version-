...
test=case30(1.3);    % input the desired case, max load can be 1.3 times
% test=case57(1);
...
building_ip=Result.B_HVAC;
zone_temp=Result.B_Ztemp;
save('building_ip','building_ip');
save('zone_temp','zone_temp');
disp('You have successfully executed the building MPC Problem, the required data is saved');
disp('You may now proceed to run the file "gonly_scenario2" to get the final results for Scenario 2');
